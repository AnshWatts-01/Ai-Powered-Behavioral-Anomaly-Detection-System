...
Uses the pre-generated dataset (`dashboard_data.csv`) and pre-trained model (`model_pipeline.pkl`).

```bash
streamlit run app.py
```

### 3. Rebuild the Project (End-to-End Pipeline)

Run the full sequence below to regenerate synthetic logs, retrain the AI model, and launch the dashboard.
